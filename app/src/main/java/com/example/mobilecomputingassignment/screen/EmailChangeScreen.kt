...
@Composable
fun EmailChangeScreen(modifier: Modifier = Modifier, navController: NavHostController, authViewModel: AuthViewModel = viewModel()) {
    ...
    Column(modifier = Modifier
        ...
        Text(text = stringResource(id = R.string.emailchangescreen_text1),
        ...
        Button(onClick = {
            authViewModel.updateEmail(email) { success, errorMessage ->
                if (success) {
            ...
            Text(text = stringResource(id = R.string.accountpage_text4)
                , fontSize = 22.sp)
        }
    }
}
...
@Composable
fun PasswordChangeScreen(modifier: Modifier = Modifier, navController: NavHostController,authViewModel: AuthViewModel = viewModel()) {
    ...
    Column(modifier = Modifier
        ...
        Text(text = stringResource(id = R.string.passwordchangescreen_text1),
        ...
        Button(onClick = {
            authViewModel.updatePassword(password) { success, errorMessage ->
                if (success) {
            ...
            Text(text = stringResource(id = R.string.accountpage_text5)
                , fontSize = 22.sp)
        }
    }
}
...
@Composable
fun NameChangeScreen(modifier: Modifier = Modifier, navController: NavHostController, authViewModel: AuthViewModel = viewModel()) {
    ...
    Column(modifier = Modifier
        ...
        Text(text = stringResource(id = R.string.namechangescreen_text1),
        ...
        Button(onClick = {
               authViewModel.updateName(name) { success, errorMessage ->
                   if (success) {
            ...
            Text(text = stringResource(id = R.string.accountpage_text3)
                , fontSize = 22.sp)
        }
    }
}
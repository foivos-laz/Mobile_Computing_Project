  ...
  const eventRef = collection(db, "clubs");

getDocs(collection(db, "clubs")).then((querySnapshot) => {
  const gallery = document.getElementById("clubs-gallery");
  ...
  querySnapshot.forEach((doc) => {
    ...
    link.href = `Clubs.html?id=${eventId}`;
